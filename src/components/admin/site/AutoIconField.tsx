    ...
    <div className="flex flex-col gap-1.5">
      ...
      {!auto && (
        <div className="flex items-center gap-2">
          <span className="flex size-9 shrink-0 items-center justify-center rounded-xl border border-dz-primary-100 bg-dz-primary-50/60 text-dz-primary-600 dark:border-dz-night-border dark:bg-white/5 dark:text-dz-night-fg">
            {Preview ? <Preview className="size-4.5" aria-hidden /> : <span className="text-xs text-dz-primary-300">—</span>}
          </span>
          <select
            value={value}
