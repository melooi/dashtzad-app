...
export function AdminSearchInput({
  ...
  return (
    <div className="relative min-w-[220px] flex-1">
      <Search className="pointer-events-none absolute top-1/2 right-3 size-4 -translate-y-1/2 text-dz-primary-400 dark:text-dz-night-faint" />
      <input
        value={value}
      ...
      {value && (
        <button
          ...
          className="focus-ring absolute top-1/2 left-2 -translate-y-1/2 rounded-md p-1 text-dz-primary-400 dark:text-dz-night-faint hover:text-dz-primary-700 dark:hover:text-dz-night-fg"
        >
          <X className="size-4" />
        </button>
      )}
