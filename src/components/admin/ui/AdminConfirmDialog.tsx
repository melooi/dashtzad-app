...
export function AdminConfirmDialog({
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="font-heading text-lg font-bold text-dz-primary-800 dark:text-dz-night-fg">{title}</h3>
        {description && <p className="mt-2 text-sm leading-6 text-dz-primary-500 dark:text-dz-night-muted">{description}</p>}
