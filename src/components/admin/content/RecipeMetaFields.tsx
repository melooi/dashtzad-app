...
const groupClass = "border-t border-dz-primary-100 pt-4 mt-4 first:mt-0 first:border-t-0 first:pt-0 dark:border-dz-night-border";
const groupHead = "mb-3 flex items-center gap-1.5 text-sm font-bold text-dz-primary-700 dark:text-dz-night-fg";
const labelClass = "text-xs font-medium text-dz-primary-700 dark:text-dz-night-muted";
...
export function RecipeMetaFields() {
  ...
  return (
    <div className="rounded-2xl border border-dz-primary-200 bg-dz-primary-50/40 p-4 dark:border-dz-night-border dark:bg-white/5">
      {/* زمان، مقدار، سختی */}
      <div className={groupClass}>
        <h4 className={groupHead}>
          <Clock className="size-4 text-dz-primary-500" /> زمان، مقدار و سختی
        </h4>
      ...
      <div className={groupClass}>
        <h4 className={groupHead}>
          <Sprout className="size-4 text-dz-primary-500" /> برچسب‌های رژیمی
        </h4>
            ...
            return (
              <button
                ...
                className={`focus-ring rounded-full border px-3 py-1.5 text-xs font-medium transition-colors ${
                  on
                    ? "border-dz-primary-500 bg-dz-primary-500 text-white"
                    : "border-dz-primary-200 bg-white text-dz-primary-600 hover:bg-dz-primary-50 dark:border-dz-night-border dark:bg-dz-night-card dark:text-dz-night-muted"
                }`}
              >
                {t.label}
              </button>
      ...
      <div className={groupClass}>
        <h4 className={groupHead}>
          <Flame className="size-4 text-dz-primary-500" /> ارزش غذایی (هر نفر) — خالی‌ها نمایش داده نمی‌شوند
        </h4>
        ...
        <label className="mt-3 flex flex-col gap-1">
          ...
          <span className="text-[11px] text-dz-primary-400 dark:text-dz-night-faint">خالی بگذارید اگر مطمئن نیستید؛ عدد جعلی ننویسید.</span>
        </label>
      </div>
      ...
      <div className={groupClass}>
        <h4 className={groupHead}>
          <ShoppingBasket className="size-4 text-dz-primary-500" /> مواد لازم
        </h4>
        <div className="overflow-hidden rounded-xl border border-dz-primary-200 dark:border-dz-night-border">
          <div className="grid grid-cols-[1fr_5rem_6rem_2rem] gap-2 bg-dz-primary-50 px-3 py-2 text-[11px] font-bold text-dz-primary-500 dark:bg-white/5 dark:text-dz-night-faint">
            <span>نام ماده</span>
          ...
          {ing.fields.length === 0 && (
            <p className="px-3 py-3 text-xs text-dz-primary-400 dark:text-dz-night-faint">هنوز ماده‌ای اضافه نشده.</p>
          )}
          {ing.fields.map((f, i) => (
            <div key={f.id} className="grid grid-cols-[1fr_5rem_6rem_2rem] items-center gap-2 border-t border-dz-primary-100 px-3 py-2 dark:border-dz-night-border">
              ...
              <button type="button" onClick={() => ing.remove(i)} className="focus-ring grid size-8 place-items-center rounded-lg text-dz-primary-400 hover:bg-dz-error/10 hover:text-dz-error" aria-label="حذف">
                <X className="size-4" />
              </button>
            </div>
          ))}
        ...
        <button
          ...
          className="focus-ring mt-2 inline-flex items-center gap-1.5 rounded-lg bg-dz-primary-100 px-3 py-1.5 text-xs font-bold text-dz-primary-700 hover:bg-dz-primary-200 dark:bg-white/10 dark:text-dz-night-fg"
        >
      ...
      <div className={groupClass}>
        <h4 className={groupHead}>
          <ListOrdered className="size-4 text-dz-primary-500" /> مراحل پخت
        </h4>
        <div className="flex flex-col gap-2">
          {stp.fields.length === 0 && (
            <p className="rounded-xl border border-dz-primary-100 px-3 py-3 text-xs text-dz-primary-400 dark:border-dz-night-border dark:text-dz-night-faint">هنوز مرحله‌ای اضافه نشده.</p>
          )}
          {stp.fields.map((f, i) => (
            <div key={f.id} className="rounded-xl border border-dz-primary-200 p-3 dark:border-dz-night-border">
              <div className="grid gap-2 @md:grid-cols-[10rem_1fr_8rem_2rem]">
                ...
                <div className="flex items-end">
                  <button type="button" onClick={() => stp.remove(i)} className="focus-ring grid size-9 place-items-center rounded-lg text-dz-primary-400 hover:bg-dz-error/10 hover:text-dz-error" aria-label="حذف">
                    <X className="size-4" />
                  </button>
                </div>
              </div>
