// AUTO-EXTRACTED byte-exact sections from the verified design markup.
/* eslint-disable */
export const BREADCRUMB_ORIG = `<!-- ===== BREADCRUMB ===== -->
...
export const MAIN_OPEN_ORIG = `<main class="dz-pdp" data-state="available" data-screen-label="صفحهٔ محصول">`;

export const BANNERS_ORIG = `<!-- ===== STATE BANNERS ===== -->
...
export const GRID_OPEN_ORIG = `<!-- ===== GRID ===== -->
  <div class="dz-pdp__grid">
    <div class="dz-pdp__main">`;

export const INFOCARD_ORIG = `<!-- ===== INFO CARD (info + gallery) ===== -->
...
export const SECTIONS_HEAD_ORIG = `<!-- ===== PAGE SECTIONS ===== -->
...
export const DESC_ORIG = `<!-- توضیح محصول -->
...
export const SPECS_ORIG = `<!-- ویژگی‌ها و مشخصات -->
...
export const RELATED_ORIG = `<!-- محصولات مرتبط -->
...
export const REVIEWS_ORIG = `<!-- دیدگاه‌ها -->
...
export const QA_ORIG = `<!-- پرسش و پاسخ -->
...
export const FAQ_ORIG = `<!-- سؤالات متداول -->
...
export const BUYBOX_ORIG = `<!-- ===== BUY SIDEBAR ===== -->
...
export const MOBILEBAR_ORIG = `<!-- ===== STICKY BUY BAR (موبایل) ===== -->
...
export const OVERLAYS_ORIG = `<!-- toast -->
