  ...
  return (
    <div className="flex flex-col gap-6">
      <SeoSection
        ...
        action={
          sample ? (
            <a href={`/products/${sample.slug}`} target="_blank" rel="noopener noreferrer" className="focus-ring inline-flex items-center gap-1.5 rounded-lg border border-dz-primary-200 dark:border-dz-night-border px-2.5 py-1.5 text-xs text-dz-primary-600 dark:text-dz-primary-300 transition-colors hover:bg-dz-primary-50 dark:hover:bg-white/5">
      ...
      >
        <div className="overflow-x-auto">
          <table className="w-full min-w-[640px] text-sm">
            <thead>
              <tr className="border-b border-dz-primary-100 dark:border-dz-night-border text-xs font-medium text-dz-primary-500 dark:text-dz-night-muted">
            ...
            <tbody>
              {TYPES.map((r) => (
                <tr key={r.type} className="border-b border-dz-primary-50 dark:border-dz-night-border last:border-0">
                  <td className="px-2 py-2.5 font-medium text-dz-primary-800 dark:text-dz-night-fg">{r.type}</td>
                  <td className="px-2 py-2.5 text-dz-primary-600 dark:text-dz-primary-300">{r.where}</td>
                  <td className="px-2 py-2.5 text-xs text-dz-primary-500 dark:text-dz-night-muted">{r.source}</td>
