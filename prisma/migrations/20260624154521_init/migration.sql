...
-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('FREE', 'PREMIUM');
...
CREATE TABLE "Order" (
    ...
    "shipping_rial" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "OrderItem" (
    ...
    "productId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "unitPrice_rial" INTEGER NOT NULL,
    "quantity" INTEGER NOT NULL,
    "lineTotal_rial" INTEGER NOT NULL,
...
CREATE TABLE "Coupon" (
    ...
    "maxDiscount_rial" INTEGER,
    "minOrder_rial" INTEGER,
    "expiresAt" TIMESTAMP(3) NOT NULL,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
